...
<div class="form-group">
  <label class="col-xs-4 control-label" for="lrn">UNIVERSITY ROLLNO.</label>  
  <div class="col-xs-6">
  <input id="lrn" name="lrn" type="text" placeholder="Enter UNIV ROLLNO " maxlength="12" class="form-control input-xs" required="">
  </div>
</div>
...
<div class="form-group">
  ...
  <table id="students" class="table table-bordered table-condensed">
    <thead>
      <tr id="heads">
        <th style="width:10%;text-align:center">UNIVERSITY ROLL NO.</th>
