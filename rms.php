...
<head>
    ...
    <title>GLA UNIVERSITY Student Management System</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color: orange">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="gla.jpg" alt="..." width="5%">GLA UNIVERSITY Student Management System</b></a>
            </div>
            <!-- Top Menu Items -->
